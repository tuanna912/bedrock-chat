...
from app.agents.tools.internet_search import internet_search_tool, InternetSearchInput
from app.agents.tools.bedrock_agent import bedrock_agent_tool, BedrockAgent, BedrockAgentInput
from app.agents.tools.knowledge import create_knowledge_tool
from app.agents.tools.google_export import google_export_tool, GoogleExportInput
...
def get_available_tools() -> list[AgentTool[Any]]:
    tools: list[AgentTool[Any]] = []
    tools.append(internet_search_tool)
    tools.append(google_export_tool)

    return tools


def get_tools(bot: BotModel | None) -> Dict[str, AgentTool[Any]]:
